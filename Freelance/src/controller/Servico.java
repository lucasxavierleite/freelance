...
public class Servico {
    ...
    public Servico(String descricao, String servico, String dataAnuncio, String cidade, String estado, String emailEmpresa, String entrega, String categorias, float valor, boolean presenca, boolean transporte, int id) {
